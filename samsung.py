...
query = "SELECT * FROM   view_samsung_galaxy_s23_ultra_256gb  "  # Modify based on your table
...
html_title = """
    ...
    <center><h1 class="title-test">SAMSUNG S23 ULTRA 256GB PRICE COMPARISON</h1></center>
"""
