...
query = "SELECT * FROM view_asus_tuf_a15_gaming_laptop"  # Modify based on your table
...
html_title = """
    ...
    <center><h1 class="title-test">ASUS TUF GAMING LAPTOP PRICE COMPARISON</h1></center>
"""
